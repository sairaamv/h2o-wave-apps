...
setup-linux: ## Create venv and install dependencies on it
	tar -xzf wave-0.12.1-linux-amd64.tar.gz
	cp start_waved.py wave-0.12.1-linux-amd64/
	cd wave-0.12.1-linux-amd64 && python3 start_waved.py
	

setup-darwin: ## Create venv and install dependencies on it
	tar -xzf wave-0.12.1-darwin-amd64.tar.gz
	cp start_waved.py wave-0.12.1-darwin-amd64/
	cd wave-0.12.1-darwin-amd64 && python3 start_waved.py
